...
export default function UserProfile() {
 ...
 if (!data?.data) return <div className="text-center py-20 text-gray-500 font-bold">Loading Profile...</div>;
 ...
 return (
 <div className="bg-white min-h-screen pt-12 pb-24 text-gray-900 font-sans">
 ...
 <Link to={`/user/${id}/followers`} className="hover:text-gray-900 :text-white">
 {formatNumber(profile.followers?.length || 0)} Followers
 </Link>
 <Link to={`/user/${id}/followings`} className="hover:text-gray-900 :text-white">
 {formatNumber(profile.followings?.length || 0)} Following
 </Link>
 </div>
 </div>

 <h1 className="hidden lg:block text-[42px] font-bold text-gray-900 mb-8 tracking-tight">
 {profile.name}
 </h1>

 {/* CONTENT TABS */}
 <div className="flex items-center gap-6 mb-8 border-b border-gray-100 overflow-x-auto custom-scrollbar">
 {optionsTab.map(opt => {
 ...
 isActive 
 ? "border-b border-gray-900 text-gray-900 font-medium" 
 ...
 <p className="text-gray-500 text-sm">{profile.name} hasn't published any posts yet.</p>
 </div>
 ) : (
 posts.map((item: any) => (
 <Post
 ...
 <div className="flex items-center justify-between">
 <span className="text-sm font-medium text-gray-600 ">Total Badges</span>
 <span className="text-sm font-bold text-gray-900 flex items-center gap-1">
 ...
 <span key={skill} className="text-sm bg-white border border-gray-200 text-gray-700 px-3 py-1.5 rounded-full">
 {skill}
 </span>
 ))}
 </div>
 ...
 <div>
 <h2 className="text-xl font-bold text-gray-900 mb-6">{userData.length} {toTitleCase(tab)}</h2>
 <div className="space-y-4">
 {userData.map((u: any) => (
 <UserCard
 _id={u._id}
 ...
 {tab === "certificates" && (
 <div className="text-center py-10">
 <p className="text-gray-500 text-sm">Certificates will appear here.</p>
 </div>
 )}
 ...
 <h2 className="text-base font-bold text-gray-900 mb-1">{profile.name}</h2>
 
 <p className="text-[#6B6B6B] text-[15px] leading-snug mb-4">
 {profile.bio || "No bio yet."}
 </p>
 ...
 <button className="bg-gray-100 text-gray-900 px-4 py-1.5 rounded-full text-sm font-medium transition-colors">
 Message
 </button>
 </>
 ) : (
 ...
 <Link to={`/user/${id}/followers`} className="flex items-center gap-2 text-[15px] text-gray-600 hover:text-gray-900 :text-white">
 <span className="font-bold">{formatNumber(profile.followers?.length || 0)}</span>
 <span>Followers</span>
 </Link>
 <Link to={`/user/${id}/followings`} className="flex items-center gap-2 text-[15px] text-gray-600 hover:text-gray-900 :text-white">
 ...
 <a href={profile.socialLinks.linkedin} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 :text-white">
 <svg xmlns="http://www.w3.org/w0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
 </a>
 )}
 {profile.socialLinks?.github && (
 <a href={profile.socialLinks.github} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 :text-white">
 <svg xmlns="http://www.w3.org/w0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
 </a>
 )}
 {profile.socialLinks?.website && (
 <a href={profile.socialLinks.website} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 :text-white">
